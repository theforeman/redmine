...
class Redmine::LinkFieldFormatTest < ActionView::TestCase
  ...
  def test_link_field_with_multiple_values_returns_array_of_links
    ...
    assert_equal ['<a href="http://foo.bar" class="external">foo.bar</a>', '<a href="http://bar.foo" class="external">bar.foo</a>'], field.format.formatted_custom_value(self, custom_value, true)
  end
end
